...
STEP_MODELS=($(ls -d $MODEL_DIR/global_step_*_consolidate | sort -V))  

# STEP_MODELS=(
#    /workspace/hyenv/neo_rlvr_training/checkpoint/qwen3-4b-neosft-rlvr/4b_global_step_80_consolidate
