...
if __name__ == '__main__':
    ...
    # json_file = 'data/step3_trajectories_split_32k.json'

    # with open(json_file, 'r', encoding='utf-8') as f:
    #     data = json.load(f)

    # first_trajectory = data[0]  
    # trajectory_text = first_trajectory.get('trajectory', None)

    # if not trajectory_text:
    #     raise ValueError(" trajectory don't have 'trajectory' ")

    # tmp_file = Path('tmp_trajectory.txt')
    ...
    # data_items, events = convert_trajectory_to_neobinder(
    #     input_file=str(tmp_file),
    #     output_file=output_file,
    #     trajectory_id='test_trajectory'
    # )

    # print("first trajectory data：")
    # print(json.dumps(data_items[0], indent=2, ensure_ascii=False))
