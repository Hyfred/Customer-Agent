...
experiment_name=qwen3-4b-publicsft-rlvr
...
# font-info/qwen3-4b-sft-SGLang-RL \ agentica-org/DeepScaleR-1.5B-Preview Qwen/Qwen3-4B-Thinking-2507

# Qwen/Qwen2.5-0.5B-Instruct\ font-info/qwen3-4b-sft-SGLang-RL deepseek-ai/DeepSeek-R1-Distill-Qwen-7B(slow-stuck)

# aime_2025=$PROJECT_DIR/dataset/yentinglin/aime_2025
# aime_2024=$PROJECT_DIR/dataset/AIME_2024_preprocessed

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    algorithm.use_kl_in_reward=False \
    algorithm.kl_ctrl.kl_coef=0.0 \
    data.train_files=$PROJECT_DIR/data/public_playground_rlvr \
    data.val_files=$PROJECT_DIR/data/yentinglin/aime_2025 \
    ...
    data.custom_cls.path=$PROJECT_DIR/recipe/retool/shopping_retool.py \
    data.custom_cls.name=CustomRLHFDataset \
    custom_reward_function.path=$PROJECT_DIR/recipe/retool/shopping_retool.py \
    custom_reward_function.name=compute_score \
    actor_rollout_ref.model.path=/workspace/hyenv/neo_rlvr_training/checkpoint/Qwen/Qwen3-4B_public_sft/global_step_24_consolidate \
    ...
    trainer.nnodes=1 \
    trainer.default_local_dir=$PROJECT_DIR/checkpoint/$experiment_name \
